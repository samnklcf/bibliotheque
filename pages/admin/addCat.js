...
// ----------------------------------lister----------------------
  ...
  const handUpdate = (e) => {
    ...
    const imgs = ref(imgDb, `categories/imgs/${v4()}`)
                ...
                <div className="padding-20 form-edit-profile bg-white">
                  <div className="form-group" >
                    ...
                    <input
                      ...
                      placeholder="Ex: Développement perso"
                      required
                  ...
                  <div className="cover-image">
                    ...
                    <div className="user-text">
                      <div className="number-eth">
                        <span className="main-price">{categorie.titre}</span>
                      </div>
                    </div>
                  </div>
                </Link>
